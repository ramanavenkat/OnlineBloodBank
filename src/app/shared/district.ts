...
export const district: Array<any> = [
        { name: 'Andhra Pradesh', districts: ['Ananthapur','Chittoor','EastGodavari','Guntur','Kurnool','Krishna','Prakasham','Srikakulam','Nellore','Vishkapatnam','Vizianagaram','West Godavari','Kadapa'] },
        {
        ...
        { name: 'Dadar and Nagar Haveli', districts: [
          'Dadra & Nagar Haveli'
        ] },
